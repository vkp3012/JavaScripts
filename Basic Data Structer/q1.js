...
//  A more complex implementation of an array can be seen below. This is known as a multi-dimensional array, or 
//  an array that contains other arrays. Notice that this array also contains JavaScript objects, 
//  which we will examine very closely in our next section, but for now, 
...
// This index doubles as the position of that item in the array, and how you reference it. However, it is important to note, 
// that JavaScript arrays are zero-indexed, meaning that the first element of an array is actually at the zeroth position,
//  not the first. In order to retrieve an element from an array we can enclose an index in brackets and append it to the end of an array,
