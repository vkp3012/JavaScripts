...
// The value gets added to the end of the array. 
...
console.log("--------------pop-----------------");
//2. pop
// We can remove elements with the pop() method.
// The value gets removed to the end of the array. 
...
//1. shift
// We can remove elements with the pop() method.
// The value gets removed to the beginning of the array. 
...
console.log("-------------unshift----------------");
//2. Unshift
// We can add elements with the unshift() method.
// The value gets removed to the beginning of the array. 
...
/*
    increase the second parameter to a number higher than our array, 
    it would not affect the result as JavaScript would simply stop as soon as it runs out of values to delete.
*/
...
console.log(arr9.concat(arrayLike)); // [ 1, 2, { '0': 'something', length: 1 } ]
