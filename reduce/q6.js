...
// it's possible to show that both filter and map can be derived as special applications of reduce.
...
function getRating(watchList){
    ...
    //                     .reduce((sumOfRating,rating)=> sumOfRating + rating)/watchList.filter(film => film.Director === "Christopher Nolan").length
    ...
    averageRating = averageRating.sum/averageRating.count;
